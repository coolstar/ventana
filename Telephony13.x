...
- (void)updateSpringBoard {
	...
	data.hasCellSignal = [[self telephonyStateProvider] isCellularRadioCapabilityActive];
	data.cellSignalBars = [[[[self telephonyStateProvider] slot1SubscriptionContext] subscriptionInfo] signalStrengthBars];
